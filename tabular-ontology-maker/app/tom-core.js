...
import {
  ...
  normalizePrefixMap
} from '../../packages/namespace-registry/src/prefix-map.js';
import {
  compactIriToCurie,
  expandCurieToIri,
  findLongestPrefixMatch
} from '../../packages/namespace-registry/src/curie.js';
import {
  createN3WriterOptionsWithPrefixes,
  selectPrefixesUsedByRdfTerms
} from '../../packages/namespace-registry/src/rdf-serialization-prefixes.js';
import {
...
import { detectRdfMimeTypeFromText } from '../../packages/format-registry/src/rdf-content-detection.js';
import {
  downloadTextFile,
...
import { isBlankNodeTerm, normalizeIriToken } from '../../packages/ontology-utils/src/index.js';
import {
  getLocalDateParts,
...
// Load BFO+CCO compact index from the app directory, independent of page URL.
loadVocabFrom(new URL('../json/bfo-cco-lookup.json', import.meta.url), 'BFO/CCO');
